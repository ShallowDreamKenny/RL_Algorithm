...
class ConvolutionalQnet(torch.nn.Module):
    ...
    def __init__(self, action_dim, in_channels=4):
        ...
        self.fc4 = torch.nn.Linear(16, 512)
...
class DQN:
    def __init__(self, state_size, hidden_dim, action_size,
        ...
        self.device = device
        self.qnet = ConvolutionalQnet(action_size, state_size).to(self.device)
        self.target_qnet = ConvolutionalQnet(action_size, state_size).to(self.device)
